...
// ノードの各メンバに値を設定
static void SetDnode(Dnode* n, const Image* x, Dnode* prev, Dnode* next)
{
	n->data = *x;		// データ
...
Dnode* Search(Dlist *list, const Image* x, int compare(const Image* x, const Image* y))
{
...
// pが指すノードの直後にノードを挿入
void InsertAfter(Dlist* list, Dnode* p, const Image* x)
{
...
// 先頭にノードを挿入
void InsertFront(Dlist* list, const Image* x)
{
	InsertAfter(list, list->head, x);
};

// 末尾にノードを挿入
void InsertRear(Dlist* list, const Image* x)
{
